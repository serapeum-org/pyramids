...
dl "$A/tos_O1_2001-2002.nc"                    cf__7v__1d3-2d3-3d1__y-asc.nc
dl "$A/sresa1b_ncar_ccsm3-example.nc"          cf__12v__1d4-2d5-3d2-4d1__y-asc.nc
dl "$A/ECMWF_ERA-40_subset.nc"                 cf__20v__1d3-3d17__y-desc.nc
...
dl "$X/air_temperature.nc"                     coards__4v__1d3-3d1__y-desc.nc
