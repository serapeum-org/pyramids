...
class TestMeshTopologyInfo:
    ...
    def test_init_all_fields(self):
        ...
        assert topo.data_variables == data_vars, (
    ...
    def test_topology_dimensions(self, topo_dim):
        ...
        assert topo.topology_dimension == topo_dim, (
...
class TestMeshVariable:
    ...
    def test_init_defaults(self):
        ...
        assert var.standard_name is None, (
    ...
    def test_n_elements_2d(self, temporal_var):
        ...
        """
        assert temporal_var.n_elements == 5, (
    ...
    def test_n_time_steps_no_time(self, face_var_1d):
        ...
        """
        assert face_var_1d.n_time_steps == 0, (
    ...
    def test_n_time_steps_with_time(self, temporal_var):
        ...
        """
        assert temporal_var.n_time_steps == 3, (
    ...
    def test_dtype_from_data(self, face_var_1d):
        ...
        """
        assert face_var_1d.dtype == np.dtype("float64"), (
    ...
    def test_sel_time_range_valid(self, temporal_var):
        ...
        assert isinstance(result, MeshVariable), (
        ...
        assert result.mesh_name == temporal_var.mesh_name, (
    ...
    def test_sel_time_range_preserves_metadata(self, temporal_var):
        ...
        assert result.standard_name == "sea_surface_height", (
