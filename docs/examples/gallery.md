...
-   [![Terrain analysis](../_images/gallery/terrain-analysis.png)](operations/terrain-analysis.ipynb)

    **[Terrain analysis](operations/terrain-analysis.ipynb)** — slope, aspect, hillshade and proximity from a DEM.

-   [![Rasterize ↔ vectorize](../_images/gallery/rasterize-vectorize.png)](operations/rasterize-vectorize.ipynb)

    **[Rasterize ↔ vectorize](operations/rasterize-vectorize.ipynb)** — burn a vector to a grid and polygonize
    it back.

-   [![COG with real data](../_images/gallery/cog-real-data.png)](cog/cog-real-data.ipynb)

    **[COG with real data](cog/cog-real-data.ipynb)** — write, validate, inspect and range-read
    Cloud-Optimized GeoTIFFs.

-   [![Mosaic & merge](../_images/gallery/mosaic-merge.png)](operations/mosaic-merge.ipynb)

    **[Mosaic & merge](operations/mosaic-merge.ipynb)** — stitch tiles into one raster and stack bands.

-   [![Visualization gallery](../_images/gallery/visualization.png)](operations/visualization.ipynb)

    **[Visualization gallery](operations/visualization.ipynb)** — images, plots, histograms and colour scales.

-   [![Spatial operations](../_images/gallery/spatial-operations.png)](dataset/spatial-operation-methods.ipynb)
